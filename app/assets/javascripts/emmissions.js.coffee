class Emissions
  ...
  setup: () ->
    ...
    target.append("<div id='total_percapita_emissions_map' style='height:250px; background-image:url(../../assets/images/Maharashtra_n.png); background-size: cover; background-repeat: no-repeat;' class='chart'><p style='color: #000000;margin-left: -90px;margin-top: 115px;text-align: center;font-weight: bold;'></p></div>");
