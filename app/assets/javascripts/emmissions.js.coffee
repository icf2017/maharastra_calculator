class Emissions
  ...
  setup: () ->
    ...
    target.append("<div id='total_percapita_emissions_map' style='height:250px; background-image:url(../../assets/images/maharastra.jpg); background-size: cover; background-repeat: no-repeat;' class='chart'><p style='color: #000000;margin-left: -45px;margin-top: 100px;text-align: center;font-weight: bold;'></p></div>");
