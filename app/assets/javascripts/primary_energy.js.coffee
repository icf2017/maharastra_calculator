class PrimaryEnergy
  ...
  setup: () ->
    ...
    $('#display').append("<h5>Explore</h5><ul class='subnav'><li><a href='#' id='energy-subnav-1' class='selected btn btn-default' onclick='twentyfifty.switchView(\"primary_energy_chart\")'>Demand & Supply</a></li><li><a href='#' id='energy-subnav-2' class='btn btn-default' onclick='twentyfifty.switchView(\"primary_energy_overview_chart\")'>Sector-wise Drilldown</a></li><li><a href='#' id='energy-subnav-3' class='btn btn-default' onclick='twentyfifty.switchView(\"primary_energy_detail_chart\")'>2012 vs 2047</a></li></ul>")
