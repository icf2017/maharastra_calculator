...
shareHTML = """
 <div id='share'>
    <div id='url'>
      ...
      <!--p>* On modern browsers, this url is the same as the one you will see in the address bar as you use the MSEC 2050 tool. On older browsers, such as Internet Explorer 6 and 7, it will not be.</p>
    </div>
    <div id='excel'>
      <h1>Sharing this scenario with the excel version of the Maharashtra State Energy Calculator 2050</h1>
      <p>
